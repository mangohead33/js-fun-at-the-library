...
console.log(pages < 1000 ? 'I could read that in a day!' : 'OK, maybe I could read that in a day and half')
...
console.log(isFavorite ? `My favorite book is ${title}!` : `I recently read the ${title} book`)
...
let dictionary = {name:`Webster's`, hasThesaurus: false};
